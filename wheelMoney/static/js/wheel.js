  ...
  var data = [{
          "label": "Question 1",
          "value": 1,
          "question": "What CSS property is used for specifying the area between the element content and its border?"
      }, // padding
      {
          "label": "Question 2",
          "value": 1,
          "question": "What CSS property is used for changing the font of text?"
      }, //font-family
      {
          "label": "Question 3",
          "value": 1,
      ...
      }, //font-size
      {
          "label": "Question 6",
          "value": 1,
          "question": "What CSS property is used for changing the color of a box?"
      }, //background-color
      {
          "label": "Question 7",
          "value": 1,
          "question": "What word do we use for specifying an HTML tag that is inside another tag?"
      }, //nesting
      {
          "label": "Question 8",
          "value": 1,
          "question": "What side of the box is the third number in: margin:1px 1px 1px 1px; ?"
      }, //bottom
      {
          "label": "Question 9",
          "value": 1,
      ...
      }, //period
      {
          "label": "Question 11",
          "value": 1,
          "question": "In CSS selectors, what character prefix should one use to specify an ID?"
      }, //pound sign
      {
          "label": "Question 12",
          "value": 1,
          "question": "In an HTML document, what tag holds all of the content people actually see?"
      }, //<body>
      {
          "label": "Question 13",
          "value": 1,
          "question": "In an HTML document, what tag specifies an unordered list?"
      }, //<ul>
      {
          "label": "Question 14",
          "value": 1,
          "question": "In an HTML document, what tag specifies the most important heading?"
      }, //<h1>
      {
          "label": "Question 15",
          "value": 1,
      ...
      }, // { }
      {
          "label": "Question 18",
          "value": 1,
          "question": "What HTML tag is used for specifying a paragraph?"
      }, //<p>
      {
          "label": "Question 19",
          "value": 1,
